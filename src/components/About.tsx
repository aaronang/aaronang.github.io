export default function About() {
  return (
    <div className="h-full bg-[#FBFDFC] overflow-y-auto font-['Geist']">
      {/* Columns */}
      <div className="flex justify-center px-4 py-4 mb-18">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4" style={{ gridTemplateColumns: '272px 272px' }}>
          {/* Name and Introduction - Spans both columns */}
          <div className="col-span-2">
            <div className="rounded-[6px] p-4">
              <h1 className="text-sm font-medium text-[#000805E5] mb-2">Aaron Ang</h1>
              <p className="text-[#000A07A0] text-sm leading-relaxed">
                I'm a product designer based in Santa Clara, California. I've spent the past 3 years designing enterprise sales software at Clari. Before that, I spent 5 years as a software engineer, turning AI research into functional prototypes at Xerox PARC.
              </p>
            </div>
          </div>

          {/* First Column - Work & Books */}
